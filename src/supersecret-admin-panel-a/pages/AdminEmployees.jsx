...
useEffect(() => {
  setFetchingAll(true); // Ensure default is "All Employees"
  setSelectEmpForSalaries([]); // Clear selected employees
    ...
    const columns = useMemo(
      () => [
        ...
        ...Array.from({ length: 7 }, (_, i) => {
          ...
          const isDisabled = (!isEditing && (isSubmitted || !isCurrentDay)); 
